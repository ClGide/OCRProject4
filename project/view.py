...
In the second part, functions enabling the user to enter data used to
override a player's ranking or a tournament's description are defined.
Those functions are called in controller_3.py.

In the third part, functions enabling the manager to save or retrieve
data from the database are defined. The functions are used by the
constructors of the two classes defined in controller_2.py.
"""
...
def collect_tournament_info() -> Tuple[str, str, str, str, str, str, str]:
    ...
    """collecting the data necessary to instantiate a Tournament object.
    ...
    tournament_name: str = (
        input("Hi, we hope our program will help you store "
              ...
              "be saved with the same name in the database. If, for example, "
              "a tournament named 'cheese' is already in the database, "
              "and you name the present"
              " tournament 'cheese', when you'll save it the previous 'cheese'"
...
def collect_results(player1: str) -> str:
    ...
    """Collecting the result of a match from the user.
...
def collect_player_info() -> Tuple[str, str, str, str, str]:
    ...
    """collecting the data necessary to instantiate a Player object.
...
def override_tournament_description() -> str:
    ...
    """Enables the user to override the tournament's description
    while it takes place.

    Returns:
        new_description: If a non-empty string is inputted, the string
            becomes the new tournament description.
    """
...
def complete_override_player_ranking() -> str:
    ...
    is overridden was inputted before by override_player_ranking().
    """
...
def what_table_to_save() -> str:
    ...
    Used by the constructor of SaveDatainDB (in controller_2.py).

    Returns:
        manager_wants_to_save: a char corresponding to the table
            the user wants to save in DB.
    """
...
def what_data_to_read() -> str:
    ...
    Used by the constructor of RequestMenu (in controller_2.py).

    Returns:
        request: a single char corresponding to the table the user wants
...
def what_tournament_name():
    """Completes the request specified before by what_data_to_read().
    """
